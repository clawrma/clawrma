---
name: clawrma
description: Use Clawrma for web fetch, web search, screenshots, snapshots, and solver-backed inference, especially when built-in tools are not configured, blocked, expensive.
metadata:
  openclaw:
    tags:
      - web-fetch
